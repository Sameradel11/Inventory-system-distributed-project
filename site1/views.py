...
def db_table(request):
    return render(request, 'site1/1-db_table/index.html')

def db_table_add(request):
    return render(request, 'site1/1-db_table/add.html')
...
def db_table_update(request,pk):
    ...
    if request.method == "POST":
        ...
        product.save()
        return redirect('site1:product')
    context = {'product': product}
    return render(request, 'site1/1-db_table/update.html')

# Views for page 2 - Location folder
def location(request):
    locations=Location1.objects.all().using('server1')
    context={'locations':locations}
    return render(request, 'site1/2-location/index2.html',context)
...
def location_add(request):
    if request.method=='POST':
        ...
        return redirect('site1:location')
    return render(request, 'site1/2-location/add2.html')
...
def location_update(request,pk):
    ...
    return render(request, 'site1/2-location/update2.html',context)
...
def inventory(request):
    ...
    return render(request, 'site1/3-inventory/index3.html',context)
...
def inventory_add(request):
    if request.method=="POST":
        ...
        return redirect('site1:inventory')
    locations=Location1.objects.all().using('server1')
    context={'locations':locations}
    return render(request, 'site1/3-inventory/add3.html',context)
...
def inventory_update(request,pk):
    ...
    return redirect('site1:inventory')
    inventory.save()
    return render(request, 'site1/3-inventory/update3.html')
...
def product(request):
    ...
    return render(request, 'site1/4-product/index4.html',context)
...
def product_add(request):
    ...
    inventories=Inventory1.objects.all().using('server1')
    context={'inventories':inventories}
    return render(request, 'site1/4-product/add4.html',context)
...
def product_inventory_add(request,pk):
    ...
    inventories=Inventory1.objects.all().using('server1')
    context={'inventories':inventories}
    return render(request,'site1/4-product/add_inventory.html',context)
...
def product_update(request,pk):
    ...
    if request.method == "POST":
        ...
        return redirect('site1:product')
    context = {'product': product}
    return render(request, 'site1/4-product/update4.html',context)
...
def home(request):
    return render(request,'site1/home/index.html')

def login(request):
    return render(request,'site1/home/login.html')

def signup(request):
    return render(request,'site1/home/signup.html')